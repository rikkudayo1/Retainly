...
const QuizPage = () => {
  ...
  const handleAnswer = (choice: string) => {
    ...
    setResults((prev) => [
      ...prev,
      { questionIndex: currentIndex, selected: choice, correct: isCorrect },
    ]);
  };

  const handleNext = () => {
    if (currentIndex + 1 >= questions.length) {
      const wrongQ = results
        .filter((r) => !r.correct)
            ...
            >
              ...
              <div className="p-5 space-y-5">
                ...
                <button
                  ...
                  disabled={
                    loading || (!selectedFile && pastedText.trim().length === 0)
                  }
                ...
                >
                  {loading ? (
                    ...
                    <>
                      <Plus className="w-4 h-4" /> <h1 className="font-mono">{t("quiz.generate")}</h1>
                    </>
                  )}
                </button>
              </div>
            ...
            {answered && (
              <div className="explanation-enter space-y-3">
                {currentQ.explanation && (
                  ...
                  >
                    <span
                      className="font-mono text-[10px] block mb-1.5"
                      style={{ color: `rgb(var(--theme-glow) / 0.4)` }}
                    >
                      // explanation
                    </span>
                  ...
                  <div className="flex items-center gap-3 font-mono text-xs mt-1">
                    <span
                      ...
                      style={{
                        ...
                        backgroundColor: "rgb(34 197 94 / 0.07)",
                        color: "#22c55e",
                      }}
                    >
              ...
              <div className="space-y-3">
                {questions.map((q, qi) => {
                  ...
                  return (
                    <div
                      key={qi}
                      className="result-row rounded-2xl border overflow-hidden"
                      style={{
                        animationDelay: `${140 + qi * 60}ms`,
                        borderColor: isCorrectResult
                          ? "rgb(34 197 94 / 0.2)"
                          : "rgb(239 68 68 / 0.2)",
                        backgroundColor: isCorrectResult
                          ? "rgb(34 197 94 / 0.03)"
                          : "rgb(239 68 68 / 0.03)",
                      }}
                    >
                      ...
                      >
                        <span
                          className="font-mono text-[10px]"
                          style={{
                            color: isCorrectResult ? "#22c55e" : "#ef4444",
                          }}
                        >
                          {isCorrectResult ? "✓" : "✗"} Q
