      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-6 bg-background text-foreground">
        <div className="w-full max-w-xl space-y-5">
          <div className="flex justify-between items-center">
            <div
              className="flex items-center gap-2 font-bold px-3 py-1.5 rounded-full text-sm"
              style={{
                backgroundColor: "rgb(34 197 94 / 0.1)",
                color: "#22c55e",
              }}
              ...
              <button
                ...
                onMouseLeave={(e) => {
                  if (!answered) {
                    ...
                    (
                      e.currentTarget as HTMLButtonElement
                    ).style.backgroundColor = `rgb(var(--theme-glow) / 0.03)`;
                  }
                }}
              >
                {choice}
  ...
  if (pageState === "results") {
    ...
    return (
      <div className="px-6 py-16 max-w-2xl mx-auto space-y-8 bg-background text-foreground min-h-screen">
        <div
          className="text-center rounded-3xl p-10 border space-y-3"
          style={{
            borderColor: `rgb(var(--theme-glow) / 0.2)`,
        ...
        >
          ...
          <p className="text-muted-foreground text-sm">
            {correct} {t("quiz.correct")} · {wrong} {t("quiz.wrong")}{" "}
            {t("quiz.out_of")} {total} {t("quiz.questions")}
          </p>
          {scorePercent === 100 && (
            <p
        ...
        >
          <div className="flex items-center gap-2 font-semibold text-sm">
            <Brain
              ...
              style={{ color: "var(--theme-primary)" }}
            />
            <span style={{ color: "var(--theme-badge-text)" }}>
              {t("quiz.work_on")}
            </span>
          </div>
